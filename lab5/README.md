...
│
└── scripts/
    ├── start.sh                # 🚀 All-in-one: запуск кластера + сборка + submit job
...
### Шаг 3: Запустить Lab 5 (всё автоматически!)
...
1. ✅ Проверит prerequisites (Docker, network)
2. ✅ Запустит Spark кластер (Master + Worker)
3. ✅ Соберёт Kotlin приложение (Gradle shadowJar)
4. ✅ Отправит Spark Streaming job
5. ✅ Запустит обработку данных в фоне
